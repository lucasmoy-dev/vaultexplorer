 ...
 * that release as an asset. This app looks for `recpocket-vX.Y.Z`, takes the
...
object Updater {
    ...
    private const val TAG_PREFIX = "recpocket-v"
    ...
    private fun get(url: String): String {
        val connection = (URL(url).openConnection() as HttpURLConnection).apply {
            ...
            setRequestProperty("User-Agent", "recpocket-updater")
    ...
    fun download(context: Context, url: String, onProgress: (Float) -> Unit): File {
        ...
        val target = File(dir, "recpocket-update.apk")
        val part = File(dir, "recpocket-update.apk.part")
        val connection = (URL(url).openConnection() as HttpURLConnection).apply {
